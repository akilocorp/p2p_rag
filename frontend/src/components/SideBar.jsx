...
export const ChatSidebar = ({ sessions = [], configId, isCollapsed, onToggle }) => {
  ...
  return (
    <aside className={`w-72 bg-gray-800/50 backdrop-blur-lg border-r border-gray-700/30 text-white h-full fixed overflow-y-auto transition-all duration-300 ${
        isCollapsed ? 'translate-x-[-100%]' : ''
      }`}>
      <button 
        className="absolute right-0 top-0 -mr-10 mt-4 p-2 rounded-full bg-gray-800/50 hover:bg-gray-700/50 text-gray-400 hover:text-gray-300 transition-colors"
        onClick={onToggle}
      >
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <button className="p-2 text-gray-400 hover:text-red-400 rounded-full transition-colors">
        ...
        <div className="mt-auto pt-4 border-t border-gray-700/50">
          <div className="flex items-center space-x-3 px-2 py-3 rounded-lg hover:bg-gray-700/30 cursor-pointer transition-colors">
